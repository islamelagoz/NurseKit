  ...
  var INTRAOP_GCKL_MAP = [
    {
      ...
      legacyTaskTags: ['t_site_procedure_verify'],
    ...
    },
    {
      ...
      legacyTaskTags: ['t_anesthesia_assist'],
    ...
    },
    {
      ...
      legacyTaskTags: ['t_sterile_field'],
    ...
    },
    {
      ...
      legacyTaskTags: ['t_count_initial'],
    ...
    },
    {
      ...
      legacyTaskTags: ['t_count_additional'],
    ...
    },
    {
      ...
      legacyTaskTags: ['t_equipment', 't_antiseptic'],
    ...
    },
    {
      ...
      legacyTaskTags: ['t_cabg_cpb_ready'],
    ...
    {
      id: 'intraopSignOutHandoff',
      nodeId: 'signOutHandoff',
      label: 'Sign-out and postop handoff',
      gcklItem: 'Procedure, count, specimen, equipment issues, and postop critical plan confirmed',
      category: 'criticalSafety',
      criticalLevel: 'hardStop',
      weight: 10,
      hardStop: true,
      taskId: 't_signout',
      legacyTaskTags: ['t_signout'],
      taskLabel: 'Perform surgical sign-out and postop handoff',
      role: 'Whole OR team',
      linkedObjects: ['signout-checklist', 'transfer-stretcher', 'icu-handoff-card'],
    ...
    },
    {
      ...
      legacyTaskTags: ['t_team_communication'],
